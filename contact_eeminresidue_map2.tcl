...
foreach pigm_resid $pigm_list {
	...
	foreach atom_index $atom_list {
		...
		puts $file "$num_dis resname$resn11/residue$pigm_resid11/atom$atom_index11 resname$resn22/residue$pigm_resid22/atom$atom_index22"
		graphics top color 1 
		graphics top line [lindex $cord11 0] [lindex $cord22 0] width 2 style solid
		label add Bonds 10/$atom_index11 10/$atom_index22
	}
close $file
label show Bonds all
label textsize 0.5
