...
foreach pigm_resid $pigm_list {
	...
	set pigm [atomselect top "resid $pigm_resid and noh"]
	#puts $pigm
	...
	foreach atom_index $atom_list {
		...
		#cycle2
		set pigm2 [atomselect top "resname $pigm_name and same resid as exwithin 10 of resid $pigm_resid"]
		set pigm_list2 [lsort -unique -integer [$pigm2 get resid]]
		$pigm2 delete
		#puts $pigm_list2
		foreach pigm_resid2 $pigm_list2 {
			if {$pigm_resid2 != $pigm_resid} {
				set pigm2 [atomselect top "resid $pigm_resid2 and noh"]
