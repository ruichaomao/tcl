...
while {$d <= 9} {
	set c 1
	set file [open Dis-N$d.dat w]
	set l_resi1 {289 286 578 583 580 872 877 874 284}
	set l_resi2 {290 293 579 584 587 873 878 881 285}
	#set l_resi2 {{861 862} {865 866} {869 870} {873 874} {877 878} {881 882} {885 887} {855 890} {857 858}}
	while {$c <= $nf} {
		echo "The $c/th frame"
		...
		unset num1 num2		
		#set porphyrin {name MG CHA CHB CHC CHD NA C1A C2A C3A C4A CMA NB C1B C2B C3B C4B CMB CBB NC C1C C2C C3C C4C CMC CAC CBC ND C1D C2D C3D C4D CMD CAD OBD CBD CGD O1D O2D CED CAB OBB}
